...
class OrdersDetailsControllerTest < ActionController::TestCase
  ...
  test "should create orders_detail" do
    assert_difference('OrdersDetail.count') do
      post :create, orders_detail: { order_id: @orders_detail.order_id, product_id: @orders_detail.product_id, quantity: @orders_detail.quantity }
    end
  ...
  test "should update orders_detail" do
    patch :update, id: @orders_detail, orders_detail: { order_id: @orders_detail.order_id, product_id: @orders_detail.product_id, quantity: @orders_detail.quantity }
    assert_redirected_to orders_detail_path(assigns(:orders_detail))
  end
