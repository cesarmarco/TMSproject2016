...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { Site: @controller.Site, body: @controller.body, name: @controller.name, title: @controller.title }
    end
  ...
  test "should update controller" do
    patch :update, id: @controller, controller: { Site: @controller.Site, body: @controller.body, name: @controller.name, title: @controller.title }
    assert_redirected_to controller_path(assigns(:controller))
  end
